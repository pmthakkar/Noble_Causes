...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $book_id = 0;
                                            $sql = "SELECT donate_book.user_id,donate_book.status,users.name,users.phone,users.email,users.gender,users.street,users.city,users.zip_code,donate_book.book_id,donate_book.course,donate_book.description,donate_book.title,donate_book.author From donate_book inner join users on donate_book.user_id=users.user_id  ";
        ...
        <script>
            ...
            function showBookDetails(book_id, name, phone, email, gender, title, author, course, description, street,
                city,
                zip_code) {
